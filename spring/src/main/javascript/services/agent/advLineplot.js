 ...
 *
 */
advLineplotAgent.$inject = ['$rootScope', '$http', '$filter', '$log', '$q'];
function advLineplotAgent($rootScope, $http, $filter, $log, $q) {
    ...
    this.getId = function (service, data) {
        ...
        // return $http.post('lineplot.json');  //returns promise
        // return '123';  //returns promise
    };
...
module.exports = advLineplotAgent;
