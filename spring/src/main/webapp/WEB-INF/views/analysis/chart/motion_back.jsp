...
<div ng-controller="analysis.chart.MotionCtrl" class="full-height"
    ...
    <div class="main-container" style="margin-top: 10px; height: 100%">
                        ...
                        <td>
                            <div style="height: 100%; border: 1px solid #999; padding: 10px; position:relative">
                                ...
                                <div ng-if="isReady" style="position:absolute; top:0; left:0; bottom:0; right:0; text-align: left">
                                    <chart-motion id="motionChart"  options="config.options" data="config.data"></chart-motion>
                                </div>
                            </div>
                ...
                <!--<table class="mu-formbox mu-formbox-vertical" style="height: 100%">-->
                    ...
                    <!--<tr>-->
                        <!--<td>-->
                            ...
                            <!--&lt;!&ndash; 팝업 레이어: Axis Field 설정 &ndash;&gt;-->
            ...
            <!--<div class="mu-col mu-col-10">-->
                <!--<div class="mu-row">-->
                    ...
                    <!--<div class="mu-col mu-col-10">-->
                        ...
                        <!--&lt;!&ndash; 팝업 레이어: Time Field 설정 &ndash;&gt;-->
