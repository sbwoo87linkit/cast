                    ...
                    <div class="mu-col mu-col-10">
                        ...
                        <div class="mu-tooltip top-right" style="width: 426px;" popup-layer="adv.timeField.setting">
                            ...
                            <div class="mu-tooltip-inner">
                                ...
                                <div class="mu-search-item timeRelative">
                                    ...
                                    <table class="mu-formbox">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="mu-selectbox" mu-select="sb1" select-model="timeField.sort.selected"
                                                     select-items="timeField.sort.list" select-change="changeOption($model)">
                                                    <button class="mu-value">{{$model.text}}</button>
                                                    <ul class="mu-list">
                                                        <li ng-repeat="opt in $data" mu-option="" value="{{opt.value}}">{{opt.text}}</li>
                                                    </ul>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="mu-btn-group">
                                                    <button class="mu-btn" ng-class="{'active': timeField.range.selected === 'userDefined'}"
                                                            ng-click="timeField.range.selected = 'userDefined'">사용자지정</button>
                                                    <button class="mu-btn" ng-class="{'active': timeField.range.selected === 'notUse'}"
                                                            ng-click="timeField.range.selected = 'notUse'">만들지 않음</button>
                                                </div>
                                                <div ng-show="timeField.range.selected === 'userDefined'">
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                범위크기
                                                            ...
                                                            <td>
                                                                <input type="text" class="mu-input ng-pristine ng-untouched ng-valid ng-not-empty"
                                                                       ng-model="timeField.range.userDefined.size">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" class="mu-input ng-pristine ng-untouched ng-valid ng-not-empty"
                                                                       ng-model="timeField.range.userDefined.start">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" class="mu-input ng-pristine ng-untouched ng-valid ng-not-empty"
                                                                       ng-model="timeField.range.userDefined.end">
                                ...
                                <div class="mu-item-group" style="padding-top: 10px;height: 30px;">
                                    <button class="mu-btn btnApply fr" type="button" ng-click="saveTimeFieldOption(timeField.sort.selected)"><spring:message code="save" /></button>
                                </div>
                            </div>
                        </div>
                        <!-- // 팝업 레이어: Time Field 설정 -->
