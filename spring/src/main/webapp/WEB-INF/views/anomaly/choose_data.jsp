...
<div ng-controller="anomaly.ChooseDataCtrl" ng-init="aliasVar = {}">
    <div class="mu-container mu-scroll-h">
        <section>
            <div class="mu-row pivotHead">
                <div class="mu-col mu-col-12">
                    <div class="mu-hgroup fl">
                        <h3 class="mu-title"><spring:message code="anomaly.choose_data" /></h3></div>
                ...
                <div class="mu-col mu-col-12">
                    ...
                    <div class="mu-panel">
                        ...
                        <div class="mu-panel-body">
                            ...
                            <div class="gridWrap">
                                <table class="mu-grid mu-grid-sort mu-grid-hover" mu-table="anomaly.grid.choose_data" rows="modelList" filter="modelText" id="ade_tbl_models">
                                    <colgroup>
                                        <col width="48px">
                                        <col width="160px">
                                        <col width="">
